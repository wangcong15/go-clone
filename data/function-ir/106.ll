define { i64, i64 } @command_line_arguments.node.Parent(i8* nest nocapture readnone %nest.36, %.command-line-arguments.node.0* %n, %IPST.5* byval nocapture readonly %args) #0 !dbg !1368 {
entry:
