define { i64, i64 } @command_line_arguments.File.Getxattr(i8* nest nocapture readnone %nest.19, %File.0* nocapture readnone %f, i64 %ctx.chunk0, i64 %ctx.chunk1, %GetxattrRequest.0* %req, %GetxattrResponse.0* nocapture readnone %resp) #0 !dbg !999 {
entry:
