define void @command_line_arguments.NewNode(%.command-line-arguments.node.0* nocapture sret %sret.formal.11, i8* nest nocapture readnone %nest.32, i64 %name.chunk0, i64 %name.chunk1, i32 %mode, i64 %parent.chunk0, i64 %parent.chunk1) #0 !dbg !1807 {
entry:
