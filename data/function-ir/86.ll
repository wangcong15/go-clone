define %File.0* @command_line_arguments.NewFile(i8* nest nocapture readnone %nest.15, i64 %name.chunk0, i64 %name.chunk1, i64 %parent.chunk0, i64 %parent.chunk1) #0 !dbg !1837 {
entry:
