define { i64, i64 } @command_line_arguments.File.Fsync(i8* nest nocapture readnone %nest.22, %File.0* nocapture readnone %f, i64 %ctx.chunk0, i64 %ctx.chunk1, %FsyncRequest.0* %req) #0 !dbg !971 {
entry:
