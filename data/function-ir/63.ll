define void @command_line_arguments.Engine.Entities({ %IPST.9, %error.0 }* nocapture sret %sret.formal.0, i8* nest nocapture readnone %nest.7, %Engine.0* %e, i64 %node.chunk0, i64 %node.chunk1) #0 !dbg !981 {
entry:
