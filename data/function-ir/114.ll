define void @command_line_arguments.nodes.Iter(%IPST.5* nocapture sret %sret.formal.14, i8* nest nocapture readnone %nest.44, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }** readonly %pointer) #0 !dbg !1637 {
entry:
