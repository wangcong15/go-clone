define { i64, i64 } @command_line_arguments.File.New(i8* nest nocapture readnone %nest.17, %File.0* nocapture readnone %f, i64 %t, i64 %name.chunk0, i64 %name.chunk1) #1 !dbg !1073 {
entry:
