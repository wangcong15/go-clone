define { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }* @command_line_arguments.nodeMetaData.Iter(i8* nest nocapture readnone %nest.51, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }** readonly %pointer) #0 !dbg !1544 {
entry:
