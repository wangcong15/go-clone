define void @command_line_arguments.nodes.Directories(%IPST.5* nocapture sret %sret.formal.15, i8* nest nocapture readnone %nest.45, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }** readonly %pointer) #0 !dbg !1574 {
entry:
