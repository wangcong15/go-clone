define { i64, i64 } @command_line_arguments.Directory.Remove(i8* nest nocapture readnone %nest.8, %Directory.0* %d, i64 %ctx.chunk0, i64 %ctx.chunk1, %RemoveRequest.0* readonly %req) #0 !dbg !1761 {
entry:
