...
then.0:                                           ; preds = %entry
  ...
  %command_line_arguments.StatusBarStyle_name.ld.0 = load { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }*, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }** @command_line_arguments.StatusBarStyle_name, align 8, !dbg !197
  %call.2 = call { i64, i64 } @github_com_golang_protobuf_proto.EnumName(i8* nest undef, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }* %command_line_arguments.StatusBarStyle_name.ld.0, i32 %.ld.6), !dbg !198
