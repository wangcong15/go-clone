define void @command_line_arguments.nodeMetaData.Set(i8* nest nocapture readnone %nest.56, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }** readonly %pointer, i64 %key.chunk0, i64 %key.chunk1, i64 %value.chunk0, i64 %value.chunk1) #0 !dbg !1553 {
entry:
