define void @command_line_arguments.Directory.Mkdir({ %Node.1, %error.0 }* nocapture sret %sret.formal.3, i8* nest nocapture readnone %nest.10, %Directory.0* %d, i64 %ctx.chunk0, i64 %ctx.chunk1, %MkdirRequest.0* readonly %req) #0 !dbg !789 {
entry:
