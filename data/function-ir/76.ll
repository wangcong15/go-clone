define { i64, i64 } @command_line_arguments.Directory.Access(i8* nest nocapture readnone %nest.5, %Directory.0* %d, i64 %ctx.chunk0, i64 %ctx.chunk1, %AccessRequest.0* %req) #0 !dbg !441 {
entry:
