define i8 @command_line_arguments.nodes.Exists(i8* nest nocapture readnone %nest.46, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }** readonly %pointer, i64 %key.chunk0, i64 %key.chunk1) #0 !dbg !1590 {
entry:
