define void @command_line_arguments.nodes.Get({ %Node.0, i8 }* nocapture sret %sret.formal.17, i8* nest nocapture readnone %nest.48, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }** readonly %pointer, i64 %key.chunk0, i64 %key.chunk1) #0 !dbg !1620 {
entry:
