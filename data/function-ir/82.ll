define void @command_line_arguments.Directory.ReadDirAll({ %IPST.2, %error.0 }* nocapture sret %sret.formal.4, i8* nest nocapture readnone %nest.11, %Directory.0* %d, i64 %ctx.chunk0, i64 %ctx.chunk1) #0 !dbg !1748 {
entry:
