define { i64, i64 } @command_line_arguments.File.Setattr(i8* nest nocapture readnone %nest.21, %File.0* %f, i64 %ctx.chunk0, i64 %ctx.chunk1, %SetattrRequest.0* %req, %SetattrResponse.0* nocapture readnone %resp) #0 !dbg !1186 {
entry:
