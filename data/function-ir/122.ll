define void @command_line_arguments.nodeMetaData.Get({ { %_type.0*, i8* }, i8 }* nocapture sret %sret.formal.18, i8* nest nocapture readnone %nest.52, { i64, i8, i8, i16, i32, i8*, i8*, i64, i8* }** readonly %pointer, i64 %key.chunk0, i64 %key.chunk1) #0 !dbg !1402 {
entry:
