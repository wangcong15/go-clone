define void @command_line_arguments.Directory.Create({ %Node.1, { %_type.0*, i8* }, %error.0 }* nocapture sret %sret.formal.1, i8* nest nocapture readnone %nest.7, %Directory.0* %d, i64 %ctx.chunk0, i64 %ctx.chunk1, %CreateRequest.0* readonly %req, %CreateResponse.0* nocapture readnone %resp) #0 !dbg !601 {
entry:
