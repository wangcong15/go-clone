define { i64, i64 } @command_line_arguments.node.Path(i8* nest nocapture readnone %nest.34, %.command-line-arguments.node.0* %n, %IPST.0* byval nocapture readonly %args) #0 !dbg !1385 {
entry:
