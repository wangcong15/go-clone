define { i64, i64 } @command_line_arguments.Engine.Actions(i8* nest nocapture readnone %nest.6, %Engine.0* nocapture readnone %e, i64 %t, i64 %name.chunk0, i64 %name.chunk1, i64 %node.chunk0, i64 %node.chunk1) #0 !dbg !883 {
entry:
