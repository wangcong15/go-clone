define { i64, i64 } @command_line_arguments.File.Write(i8* nest nocapture readnone %nest.24, %File.0* %f, i64 %ctx.chunk0, i64 %ctx.chunk1, %WriteRequest.0* %req, %WriteResponse.0* %resp) #0 !dbg !1221 {
entry:
