define void @command_line_arguments.File.Open({ { %_type.0*, i8* }, %error.0 }* nocapture sret %sret.formal.7, i8* nest nocapture readnone %nest.18, %File.0* %f, i64 %ctx.chunk0, i64 %ctx.chunk1, %OpenRequest.0* %req, %OpenResponse.0* nocapture readnone %resp) #0 !dbg !1085 {
entry:
